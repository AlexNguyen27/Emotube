...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/resources/homePage/css/bootstrap.min.css"
    />
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/resources/homePage/css/font-awesome.min.css"
    />
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/resources/homePage/css/home-user.css"
    />
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/resources/homePage/css/_all-skins.min.css"
    />
      ...
      <aside class="main-sidebar">
        ...
        <!-- /.search form -->
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="menu">
              <a href="user/your-channel.htm">
                <i class="fa fa-user"></i> <span>Your channel</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <c:forEach var="c" items="${categories}">
                  <li
                    ><a href="./user/category/view-video/${c.id}.htm"
                      ><i class="fa fa-fire"></i>${c.name}</a
                    ></li
                  >
                </c:forEach>
              </ul>
      ...
      <div class="content-wrapper" style="min-height: 600px !important">
        ...
        <section class="content-header">
          <div style="padding-bottom: 15px">
            <img
              src="./resources/image/facebook_cover.png"
              alt="emotube_logo"
            />
          </div>
          <h3 style="margin-top: 0px; font-style: italic;">
            <i
                class="far fa-heart"
              style="margin-right: 10px; font-size: 18px ;font-style: italic;"
            ></i
            >${categoryName}
            <i
              class="far fa-heart"
        ...
        <section class="content">
          ...
          >
            <c:forEach var="v" items="${videos}">
              <div
                class="card col-md-3 thumbnail"
              onclick="location.href='./user/view-video/${v.id}.htm'"
               id="video"
              >
                <div title="${v.description}" data-toggle="tooltip" data-placement="bottom" style="background-color: #F9F9F9">
                  <img
                    src="${v.image_url}"
                    class="card-img-top"
                    alt="url_image"
                  ...
                  <div class="card-body" style="padding-left: 5px">
                    ...
                    <p class="card-text"
                      >${v.views} ${v.views > 1 ? 'views' : 'view'}</p
                    >
                  </div>
                </div>
              </div>
