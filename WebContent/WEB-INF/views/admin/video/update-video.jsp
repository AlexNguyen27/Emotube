  ...
  <body>
   <header>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="./admin/user/view-user/${userId}.htm"
                >User Info<span class="sr-only">(current)</span></a
              >
            </li>
          </ul>
    ...
    <div class="container">
      ...
      <form:form
        action="admin/user-${userId}/update-video/${id}.htm"
      ...
      >
        ...
        <div class="mt-2 pl-3">
          ...
          <button
            type="button"
            onclick="location.href='./admin/user/view-user/${userId}.htm'"
