...
public class UserChannelController {
	...
	public String yourChannel(ModelMap model, HttpServletRequest request) {
	...
	public String changePassword(ModelMap model, @PathVariable("userId") Integer userId, HttpServletRequest request) {
		HttpSession httpSession = request.getSession(true);

		if (commonDAO.isLogin(httpSession)) {
			User userLogin = (User) httpSession.getAttribute("user");
			if (userLogin.getRole().equals("user") && userLogin.getId().equals(userId)) {
				...
				return "user/your-channel/change-password";
			}
